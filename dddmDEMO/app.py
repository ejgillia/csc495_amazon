...
def weights():
	...
	if request.method == "POST":
		...
		print(list_form)
		userWeightFunction = demoscriptv1.userValue(list_form)
		print(userWeightFunction)
		citylist = userWeightFunction[0]
		maxscore = userWeightFunction[1]
		print(citylist)
		print(maxscore)
		return render_template('displayscore.html',cities=citylist,MaxScore=maxscore)
